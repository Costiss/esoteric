...
- You dont need to finish a task every run, you can leave it as "In Progress". In this case:
  - reflect on what you learned and yout thoughts in journal.txt
  - check if any relevant information should be added to AGENTS.md
  - stop working
- Once a task is completed:
  ...
  - check if any relevant information should be added to AGENTS.md
  - stop working
- If you have any questions or need help, ask for it. Like architecture decisions, code reviews, etc. Do not hesitate to ask for help when needed.
